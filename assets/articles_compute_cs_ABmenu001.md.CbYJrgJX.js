import{_ as a,c as n,o as p,ae as e}from"./chunks/framework.PNVe5cA1.js";const t="/techlog/assets/ReadCodeDemoAll.BsKd2G0-.svg",i="/techlog/assets/Core%E6%A0%B8%E5%BF%83%E7%B1%BB%E5%9B%BE.D9NuIx4M.svg",l="/techlog/assets/PLC%E9%80%9A%E8%AE%AF%E6%A8%A1%E5%9D%97%E7%B1%BB%E5%9B%BE.BNJ1e37Q.svg",c="/techlog/assets/%E6%95%B0%E6%8D%AE%E5%8F%98%E5%8C%96%E6%A3%80%E6%B5%8B%E7%B1%BB%E5%9B%BE.DfVM0KeZ.svg",d="/techlog/assets/%E6%95%B0%E6%8D%AE%E4%B8%8A%E6%8A%A5%E7%B1%BB%E5%9B%BE.BgB0Nuq6.svg",o="/techlog/assets/%E8%BF%9E%E6%8E%A5%E6%81%A2%E5%A4%8D%E6%A8%A1%E5%9D%97%E7%B1%BB%E5%9B%BE.DsXAoxVY.svg",h="/techlog/assets/%E6%9C%80%E7%BB%88%E7%B3%BB%E7%BB%9F%E6%80%BB%E7%B1%BB%E5%85%B3%E7%B3%BB%E5%9B%BE.D1hAy8iF.svg",C=JSON.parse('{"title":"一、总工程包图","description":"","frontmatter":{},"headers":[],"relativePath":"articles/compute/cs/ABmenu001.md","filePath":"articles/compute/cs/ABmenu001.md"}'),r={name:"articles/compute/cs/ABmenu001.md"};function g(k,s,u,b,v,y){return p(),n("div",null,[...s[0]||(s[0]=[e('<h1 id="一、总工程包图" tabindex="-1">一、总工程包图 <a class="header-anchor" href="#一、总工程包图" aria-label="Permalink to &quot;一、总工程包图&quot;">​</a></h1><p><img src="'+t+'" alt="image-20260904183420486"></p><h1 id="二、core-核心库类图" tabindex="-1">二、Core 核心库类图 <a class="header-anchor" href="#二、core-核心库类图" aria-label="Permalink to &quot;二、Core 核心库类图&quot;">​</a></h1><p><img src="'+i+'" alt="image-20260904183420486"></p><h1 id="三、plc-通讯模块类图" tabindex="-1">三、PLC 通讯模块类图 <a class="header-anchor" href="#三、plc-通讯模块类图" aria-label="Permalink to &quot;三、PLC 通讯模块类图&quot;">​</a></h1><p><img src="'+l+'" alt="image-20260904183420486"></p><h1 id="四、battery-业务读取类图" tabindex="-1">四、Battery 业务读取类图 <a class="header-anchor" href="#四、battery-业务读取类图" aria-label="Permalink to &quot;四、Battery 业务读取类图&quot;">​</a></h1><p>![image-20260904183420486](./ABmenu001.assets/Battery 业务读取类图.svg)</p><h1 id="五、实时轮询-数据变化检测类图" tabindex="-1">五、实时轮询 + 数据变化检测类图 <a class="header-anchor" href="#五、实时轮询-数据变化检测类图" aria-label="Permalink to &quot;五、实时轮询 + 数据变化检测类图&quot;">​</a></h1><p>![image-20260904183420486](./ABmenu001.assets/实时轮询 + 数据变化检测类图.svg)</p><h1 id="六、数据变化检测类图" tabindex="-1">六、数据变化检测类图 <a class="header-anchor" href="#六、数据变化检测类图" aria-label="Permalink to &quot;六、数据变化检测类图&quot;">​</a></h1><p><img src="'+c+'" alt="image-20260904183420486"></p><h1 id="七、数据上报类图" tabindex="-1">七、数据上报类图 <a class="header-anchor" href="#七、数据上报类图" aria-label="Permalink to &quot;七、数据上报类图&quot;">​</a></h1><p><img src="'+d+'" alt="image-20260904183420486"></p><h1 id="八、连接恢复模块类图" tabindex="-1">八、连接恢复模块类图 <a class="header-anchor" href="#八、连接恢复模块类图" aria-label="Permalink to &quot;八、连接恢复模块类图&quot;">​</a></h1><p><img src="'+o+'" alt="image-20260904183420486"></p><h1 id="九、最终系统总类关系图" tabindex="-1">九、最终系统总类关系图 <a class="header-anchor" href="#九、最终系统总类关系图" aria-label="Permalink to &quot;九、最终系统总类关系图&quot;">​</a></h1><p><img src="'+h+`" alt="image-20260904183420486"></p><h1 id="一、这个案例要做什么" tabindex="-1">一、这个案例要做什么 <a class="header-anchor" href="#一、这个案例要做什么" aria-label="Permalink to &quot;一、这个案例要做什么&quot;">​</a></h1><p>不是只解决这一次 <code>Battery_Data</code>。 而是做一个以后可以反复使用的：</p><blockquote><p><strong>上位机自动化基础类库</strong> 以后新建一个项目，例如：</p></blockquote><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>海辰组盘机</span></span>
...
<span class="line"><span>        ↓</span></span>
<span class="line"><span>List&lt;BatteryData&gt;</span></span></code></pre></div><p><strong>这才是下一站。</strong></p><p>你现在先不用写任何新代码。先把上面这张架构图和每一层的职责吃透。我们后面的实操就严格按照这棵树往下走，不再让你在多个层之间来回跳。</p>`,302)])])}const x=a(r,[["render",g]]);export{C as __pageData,x as default};
