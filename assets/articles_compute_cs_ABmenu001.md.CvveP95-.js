...
<span class="line"><span>异常处理</span></span></code></pre></div><hr><h1 id="二、先看最终项目结构" tabindex="-1">二、先看最终项目结构 <a class="header-anchor" href="#二、先看最终项目结构" aria-label="Permalink to &quot;二、先看最终项目结构&quot;">​</a></h1><p>目前是：</p><p><img src="`+i+`" alt="image-20260904183420486"></p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>ByteQuestor.Automation</span></span>
...
<span class="line"><span>        ↓</span></span>
<span class="line"><span>List&lt;BatteryData&gt;</span></span></code></pre></div><p><strong>这才是下一站。</strong></p><p>你现在先不用写任何新代码。先把上面这张架构图和每一层的职责吃透。我们后面的实操就严格按照这棵树往下走，不再让你在多个层之间来回跳。</p>`,285)])])}const u=a(t,[["render",l]]);export{k as __pageData,u as default};
